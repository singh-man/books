...
Now that we understand the pattern, we can develop a general recursive algorithm:We generate all permu­ tations of a string s₁ .... sₙ by "chopping off" the last character and generating  all permutations  of s₁ .....  sₙ₋₁. Once we have the list of all permutations of s₁ ..... Sₙ₋₁, we iterate through this list. For each string in it, we insert Sₙ  into every location of the string.
