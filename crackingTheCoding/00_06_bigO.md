...
**VI.2     The following code computes aᵇ. What is its runtime ?**
```java
...
4. O(a/b). The variable count will eventually equal a/b. The  while loop iterates count times. Therefore, it iterates a/b times.
