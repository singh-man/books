...
Academics use big O, big 0 (theta), and big O (omega) to describe runtimes.
...
Therefore, there will be 2° + 2¹ + 2² + 2³ +  2⁴ + . • . +  2ᴺ  (which is 2⁽ᴺ⁺¹⁾ - 1) nodes. (See "Sum of Powers of 2" on page 630.)
